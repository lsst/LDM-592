...
\item
Since provenance will be sufficient to reproduce the datasets in the value added repositories, long term persistence is not manditory and backups need not be performed.  The collaborators need a sufficiently long retention time to be able to examine the contents of the value added repositories that reside at the Data Facility.
