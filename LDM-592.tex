...
\setDocChangeRecord{%
\addtohist{}{2017-11-13}{Initial version from Working Group \citedsp{LDM-563} internal spreadsheet.} {T.~Jenness}
\addtohist{1.0}{2018-02-14}{Approved in \jira{RFC-413}}{T.~Jenness}
}
...
\item[Collection] A group of Datasets that has the following three properties:
\begin{itemize}
...
\item[DataRepository] A group of Datasets and Collections backed by a single database, but possibly multiple storage systems.
