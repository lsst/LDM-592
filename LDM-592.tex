...
\setDocChangeRecord{%
\addtohist{1.0}{2017-10-31}{Initial version from Working Group internal spreadsheet.} {T.~Jenness}
}
...
\item
Like \useref{DRP2}a, but the dataset is predefined small part of a larger dataset (such as the PSF of a calibrated exposure).
